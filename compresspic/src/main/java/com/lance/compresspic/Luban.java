...
import static com.lance.compresspic.Preconditions.checkNotNull;
...
public class Luban {
     ...
     *
     * @param angle  the angle will be rotating ��ת�ĽǶ�
     * @param bitmap target image               Ŀ��ͼƬ
     */
     ...
     * @param bitmap   the image what be save   Ŀ��ͼƬ
     * @param size     the file size of image   �����С
     */
